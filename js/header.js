...
$(function(){
    ...
    setNavBarMargin('NavbarHeader', 'LoginWrapper', $(window).width()); //设置导航栏margin
...
function setNavBarMargin(navEle, loginEle, windowWidth){ //设置导航栏,登录与logo margin-top一样
    var marginTop
    if(windowWidth > 750){
        marginTop = $(".logo_img").css('margin-top');
    }else{
        marginTop = '0';
    }
